...
\paragraph*{Definition: Nachbarschaft}\label{para:Nachbarschaft}
Die Nachbarschaft ist definiert durch einen Kreis (im 2-dimensionalen oder eine Sphäre im 3-dimensionalen) mit fixem Radius. Einheiten innerhalb dieses Kreises sind Teil der Nachbarschaft, Einheiten außerhalb nicht.\\
...
\subsubsection{Auswirkungen von Rauschen}
\note[Lorem ipsum}
